  ...
  return await new Promise((resolve) => {
    ...
    const finish = (ok) => {
      ...
      try {
        ...
        // Never assign an empty src: under file:// Chromium resolves it to the
        // current HTML document and emits an unsafe unique-origin warning.
...
export async function loadMJCFModel(opts = {}) {
  ...
  try {
    ...
    model.userData.__automindBuild = 'MJCF BUILD242 — detailed body mechanics/physics, persistent joint overlays, safe local HTML download, internal hierarchy scrolling';
