...
// AutoMind BUILD229 MJCF loader — global damped least-squares closed-chain kinematics.
...
export async function loadMJCFModel(opts = {}) {
  ...
  model.userData.__automindBuild = 'MJCF BUILD228 — passive ball DOFs with frame-sliced closed-chain settling';
