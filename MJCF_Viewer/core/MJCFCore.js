...
export async function loadMJCFModel(opts = {}) {
  ...
  try {
    ...
    model.userData.__automindBuild = 'MJCF BUILD240 — upright Inventor orientation, clean MJCF body hierarchy, component details, HTML download, remote click audio, original hover';
