...
export async function loadMJCFModel(opts = {}) {
  ...
  try {
    ...
    model.userData.__automindBuild = 'MJCF BUILD238 — upright Inventor orientation, non-blocking hierarchy and bounded thumbnails, remote click audio, original hover';
