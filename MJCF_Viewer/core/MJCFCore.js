...
export async function loadMJCFModel(opts = {}) {
  ...
  try {
    ...
    model.userData.__automindBuild = 'MJCF BUILD239 — upright Inventor orientation, MJCF body-tree Components, lazy Geometry, body thumbnails, remote click audio, original hover';
