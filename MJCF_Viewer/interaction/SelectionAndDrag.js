...
// MJCF BUILD224 interaction: RAF-coalesced joint commands, low-allocation drag and 360-camera controls.
/* global THREE */
...
export function attachInteraction({ scene, camera, renderer, controls, robot, selectMode = 'link', getSectionPlane = null, onSelectLink = null, onKinematicCommit = null }) {
  ...
  function flushPendingJointCommit({ force = false } = {}) {
    ...
    const maxStep = force ? Infinity : (d.type === 'prismatic' ? 0.012 : 0.10);
