...
// BUILD231: lazy ZIP assets, direct textures, indexed geometry and low-memory rendering.
...
export function render(opts = {}) {
  ...
  debugLog('render init', {
    mode: 'MJCF BUILD231_LAZY_ASSETS_DIRECT_TEXTURES',
    selectMode,
    IA_Widgets,
  ...
  const app = {
    ...
    syncPresentation: (force = true) => core.syncKinematicPresentation?.({ force: !!force }),
    IA_Widgets,
    debug: !!opts.debug,
    options: opts,
    sectionPlane: null,
  ...
  app.ready = (async () => {
    try {
      ...
      debugLog('MJCF loaded BUILD231_LAZY_ASSETS_DIRECT_TEXTURES', {
        robot: robot.name,
  ...
  if (typeof window !== 'undefined') {
    ...
    window.MJCFViewer.__build = 'BUILD230_PROXY_RENDER_SECTION_FIX';
