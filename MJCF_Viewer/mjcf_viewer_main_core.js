...
// BUILD248: high-resolution component sheets, complete technical geometry, persistent thumbnails in exported HTML and Show All on Back.
...
export function render(opts = {}) {
  ...
  debugLog('render init', {
    mode: 'MJCF BUILD248_CHILD_HIGHLIGHTS_JOINT_COLORS',
    selectMode,
    IA_Widgets,
  ...
  if (typeof window !== 'undefined') {
    ...
    window.MJCFViewer.__build = 'BUILD248_COMPONENT_TECHNICAL_SHEETS';
