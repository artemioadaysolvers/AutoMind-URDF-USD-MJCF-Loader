...
export function render(opts = {}) {
  ...
  debugLog('render init', {
    mode: 'MJCF BUILD240_COMPONENT_DETAILS_HTML_DOWNLOAD',
    selectMode,
    IA_Widgets,
  ...
  app.ready = (async () => {
    try {
      ...
      // BUILD240: build the body hierarchy after the first stable frames, then warm
      ...
      debugLog('MJCF loaded BUILD240_COMPONENT_DETAILS_HTML_DOWNLOAD', {
        robot: robot.name,
