...
// BUILD230: viewport proxy render modes + section clipping synchronization.
...
export function render(opts = {}) {
  ...
  debugLog('render init', {
    mode: 'MJCF BUILD230_PROXY_RENDER_SECTION_FIX',
    selectMode,
    IA_Widgets,
  ...
  app.ready = (async () => {
    try {
      ...
      debugLog('MJCF loaded BUILD230_PROXY_RENDER_SECTION_FIX', {
        robot: robot.name,
