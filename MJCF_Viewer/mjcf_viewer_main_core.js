...
// BUILD234: pooled translucent hover, canonical assets, direct textures, indexed picking and on-demand rendering.
...
export function render(opts = {}) {
  ...
  debugLog('render init', {
    mode: 'MJCF BUILD235_CAMERA_INVALIDATION_POOLED_OVERLAY',
    selectMode,
    IA_Widgets,
  ...
  app.ready = (async () => {
    try {
      ...
      debugLog('MJCF loaded BUILD235_CAMERA_INVALIDATION_POOLED_OVERLAY', {
        robot: robot.name,
  ...
  if (typeof window !== 'undefined') {
    ...
    window.MJCFViewer.__build = 'BUILD235_CAMERA_INVALIDATION_POOLED_OVERLAY';
