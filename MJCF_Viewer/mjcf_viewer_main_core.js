...
// BUILD233: fast hover, canonical assets, direct textures, indexed picking and on-demand rendering.
...
export function render(opts = {}) {
  ...
  debugLog('render init', {
    mode: 'MJCF BUILD233_FAST_HOVER_CANONICAL_ASSETS',
    selectMode,
    IA_Widgets,
  ...
  app.ready = (async () => {
    try {
      ...
      debugLog('MJCF loaded BUILD233_FAST_HOVER_CANONICAL_ASSETS', {
        robot: robot.name,
  ...
  if (typeof window !== 'undefined') {
    ...
    window.MJCFViewer.__build = 'BUILD233_FAST_HOVER_CANONICAL_ASSETS';
