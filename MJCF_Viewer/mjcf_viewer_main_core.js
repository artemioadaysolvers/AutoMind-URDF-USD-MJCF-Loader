...
// BUILD225: frame-budgeted closed-chain drag + dirty presentation synchronization.
...
export function render(opts = {}) {
  ...
  debugLog('render init', {
    mode: 'MJCF BUILD228_FRAME_SLICED_CLOSED_CHAIN',
    selectMode,
    IA_Widgets,
  ...
  app.ready = (async () => {
    try {
      ...
      debugLog('MJCF loaded BUILD228_FRAME_SLICED_CLOSED_CHAIN', {
        robot: robot.name,
  ...
  if (typeof window !== 'undefined') {
    ...
    window.MJCFViewer.__build = 'BUILD228_FRAME_SLICED_CLOSED_CHAIN';
