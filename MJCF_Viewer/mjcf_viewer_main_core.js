...
// BUILD239: MJCF body-tree Components panel, lazy Geometry rows, body thumbnails, original hover, remote audio and on-demand rendering.
...
export function render(opts = {}) {
  ...
  debugLog('render init', {
    mode: 'MJCF BUILD239_BODY_TREE_COMPONENTS',
    selectMode,
    IA_Widgets,
  ...
  app.ready = (async () => {
    try {
      ...
      // BUILD239: build the body hierarchy after the first stable frames, then warm
      ...
      debugLog('MJCF loaded BUILD239_BODY_TREE_COMPONENTS', {
        robot: robot.name,
  ...
  if (typeof window !== 'undefined') {
    ...
    window.MJCFViewer.__build = 'BUILD239_BODY_TREE_COMPONENTS';
