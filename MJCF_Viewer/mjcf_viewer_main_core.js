...
export function render(opts = {}) {
  ...
  debugLog('render init', {
    mode: 'MJCF BUILD227_SYNCHRONIZED_CLOSED_CHAIN',
    selectMode,
    IA_Widgets,
  ...
  app.ready = (async () => {
    try {
      ...
      debugLog('MJCF loaded BUILD224_FLUID_KINEMATIC_PIPELINE', {
        robot: robot.name,
  ...
  if (typeof window !== 'undefined') {
    ...
    window.MJCFViewer.__build = 'BUILD224_FLUID_KINEMATIC_PIPELINE';
