...
// BUILD246: high-resolution component sheets, complete technical geometry, persistent thumbnails in exported HTML and Show All on Back.
...
export function render(opts = {}) {
  ...
  debugLog('render init', {
    mode: 'MJCF BUILD246_COMPONENT_TECHNICAL_SHEETS',
    selectMode,
    IA_Widgets,
  ...
  app.ready = (async () => {
    try {
      ...
      debugLog('MJCF loaded BUILD246_COMPONENT_TECHNICAL_SHEETS', {
        robot: robot.name,
  ...
  if (typeof window !== 'undefined') {
    ...
    window.MJCFViewer.__build = 'BUILD246_COMPONENT_TECHNICAL_SHEETS';
