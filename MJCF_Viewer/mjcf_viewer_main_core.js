...
// BUILD238: non-blocking bounded thumbnail warm-up, original hover, remote GitHub button audio and on-demand rendering.
...
export function render(opts = {}) {
  ...
  debugLog('render init', {
    mode: 'MJCF BUILD238_NONBLOCKING_THUMBNAILS_REMOTE_AUDIO_OLD_HOVER',
    selectMode,
    IA_Widgets,
  ...
  app.ready = (async () => {
    try {
      ...
      // BUILD238: build the hierarchy after the first stable frames, then warm
      // thumbnails independently. Components remains clickable throughout; a
      ...
      debugLog('MJCF loaded BUILD238_NONBLOCKING_THUMBNAILS_REMOTE_AUDIO_OLD_HOVER', {
        robot: robot.name,
  ...
  if (typeof window !== 'undefined') {
    ...
    window.MJCFViewer.__build = 'BUILD238_NONBLOCKING_THUMBNAILS_REMOTE_AUDIO_OLD_HOVER';
