...
// BUILD237: upright orientation, robust hierarchy/thumbnails, original hover, remote GitHub button audio and on-demand rendering.
...
export function render(opts = {}) {
  ...
  debugLog('render init', {
    mode: 'MJCF BUILD237_HIERARCHY_THUMBNAILS_REMOTE_AUDIO_OLD_HOVER',
    selectMode,
    IA_Widgets,
  ...
  app.ready = (async () => {
    try {
      ...
      debugLog('MJCF loaded BUILD237_HIERARCHY_THUMBNAILS_REMOTE_AUDIO_OLD_HOVER', {
        robot: robot.name,
  ...
  if (typeof window !== 'undefined') {
    ...
    window.MJCFViewer.__build = 'BUILD237_HIERARCHY_THUMBNAILS_REMOTE_AUDIO_OLD_HOVER';
