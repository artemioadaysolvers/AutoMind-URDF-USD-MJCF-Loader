...
export function createComponentsPanel(app, theme) {
  ...
  function jointBadge(joint, text = null, relationshipColor = null) {
    const badge = document.createElement('span');
    const color = relationshipColor || jointColor(joint);
  ...
  function jointCard(joint) {
    ...
    header.append(title, jointBadge(joint, null, RELATION_COLORS.parent));
  ...
  function childConnectionCard(connection) {
    ...
    if (joints.length) joints.forEach(joint => badges.appendChild(jointBadge(joint, null, RELATION_COLORS.child)));
    else badges.appendChild(jointBadge({ type: 'fixed' }, 'Fixed', RELATION_COLORS.child));
