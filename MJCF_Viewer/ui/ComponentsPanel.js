...
export function createComponentsPanel(app, theme) {
  ...
  // Joint-class badges intentionally avoid red and blue so they cannot be
  // confused with relationship badges: Parent = blue, Child = red.
  const JOINT_CLASS_COLORS = Object.freeze({
    Revolute: '#16a34a',     // green
    Prismatic: '#f97316',    // orange
    Spherical: '#7c3aed',    // violet
    Free: '#92400e',         // brown
    Cylindrical: '#0d9488',  // teal
    Planar: '#c026d3',       // magenta
    Screw: '#65a30d',        // lime
    Universal: '#a16207',    // amber-brown
    Fixed: '#64748b',        // gray
    Other: '#334155'         // slate
  });
