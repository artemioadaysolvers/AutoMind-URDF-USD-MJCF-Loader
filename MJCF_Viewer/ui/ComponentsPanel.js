// AutoMind MJCF body-tree Components panel — BUILD264.
// BUILD248:
...
export function createComponentsPanel(app, theme) {
  ...
  function showAllAndClearSelection({ clearChildHighlights = false } = {}) {
    // Restore the real CAD materials first. Running Show All while the temporary
    // detail materials are active lets section/visibility code cache those
    // temporary materials and is the reason Back could cancel Section or leave
    // the component colour altered.
